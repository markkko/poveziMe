...
fun PoveziMeApplication.getCarSubComponent(): CarSubComponent {
    if (null == carSubComponent)
        carSubComponent = PoveziMeApplication.component!!.plus(CarModule())
    return carSubComponent!!
}
fun PoveziMeApplication.releaseCarSubComponent() {
    carSubComponent = null
}
